...
namespace EMRCoreService
{
    ...
    public class ParseXMLService
    {
        ...
        {
            DirectoryInfo d = new DirectoryInfo(ConfgService.config.GetSection(AppConstants.Appsettings)[AppConstants.UploadPath]);
        ...
        {
            string filePath = ConfgService.config.GetSection(AppConstants.Appsettings)[AppConstants.UploadPath] + "\\" + fileName;
        ...
        {
            string URI = ConfgService.config.GetSection(AppConstants.Appsettings)[AppConstants.GoAPiUrl];
        ...
        public static void MoveXmlFileToArchieve(string fileName)
        {
            ...
            string uploadPath = ConfgService.config.GetSection(AppConstants.Appsettings)[AppConstants.UploadPath];
            string archievePath = ConfgService.config.GetSection(AppConstants.Appsettings)[AppConstants.ArchievePath];
